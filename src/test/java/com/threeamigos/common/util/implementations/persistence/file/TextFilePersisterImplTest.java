...
class TextFilePersisterImplTest {
    ...
    private static class TestClassTextFilePersister extends TextFilePersister<TestClass> implements Persister<TestClass> {
        ...
        @Override
        protected void loadFromText(BufferedReader reader, TestClass entity) throws IOException, IllegalArgumentException {
        ...
        @Override
        protected void saveAsText(PrintWriter printWriter, TestClass entity) throws IOException, IllegalArgumentException {
